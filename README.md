...
- update добавил файл migrations/0005_add_device_fields.py в проэкт не тестил еще,
  но возможно миграция в ручную большне не понадобится
...
sudo nano /opt/netbox-4.4.0/venv/lib/python3.11/site-packages/netbox_acls/migrations/0005_add_device_fields.py
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dcim', '__first__'),  # Используем первую доступную миграцию dcim
