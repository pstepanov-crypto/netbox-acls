# /opt/netbox/plugins/netbox-acls/netbox_acls/forms/filtersets.py
...
# ИЗМЕНИТЬ ЭТОТ ИМПОРТ:
# from .choices import (  # <-- Это неправильно, choices не в папке forms
from ..choices import (  # <-- Исправить на ..
    ACLActionChoices,
...
class ACLStandardRuleFilterForm(NetBoxModelFilterSetForm):
    ...
    fieldsets = (
        ...
        FieldSet("source_prefix", name=_("Source Details")),
    )
    ...
    # Source selectors - ИЗМЕНИТЬ: убрать *_id, сделать просто текстовые поля
...
class ACLExtendedRuleFilterForm(NetBoxModelFilterSetForm):
    ...
    fieldsets = (
        ...
        FieldSet("source_prefix", name=_("Source Details")),
        FieldSet("destination_prefix", name=_("Destination Details")),
        FieldSet("source_ports", "destination_ports", name=_("Port Details")),
    )
    ...
    # Destination selectors - ИЗМЕНИТЬ: убрать *_id, сделать просто текстовые поля
